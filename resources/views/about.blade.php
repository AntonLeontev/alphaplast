...
@section('content')
    <main>
        ...
        <section class="about-text">
            <div class="container">
                <p>
                    Производство пластиковой тары ООО «Альфапласт» уже 15 лет является лидером рынка по производству
                    ПЭТ-упаковки. Технология производства ПЭТ выработана для каждого вида тары.
                </p>
                <p>
                    <span>Мы предлагаем клиентам как готовые комплекты:</span> ПЭТ-банки с крышкой, ПЭТ-бутылки с колпачком,
                    ПЭТ-флаконы с крышкой, преформы с крышкой, так и отдельные ПЭТ-преформы любых выпускаемых стандартов.
                </p>
                <p>
                    На выбор клиенту предлагаем прозрачный или цветной пластик, различные размеры, крышки и колпачки.
                </p>
                <p>
                    Помимо стандартных моделей и форм из каталога, создаём изделия из пластика на заказ с индивидуальным
                    дизайном и ПЭТ-прессформы для выдува бутылки, банки или флакона заданной формы. Возможно нанесение
                    объёмных названий и логотипов любой сложности на поверхности выдуваемых пэт банок и бутылок.
                </p>
            </div>
        </section>
        ...
        <section class="about-adv">
            <div class="container">
                ...
                <p class="about-adv__text">
                    «Альфапласт» хорошо зарекомендовал себя, поэтому нашу продукцию заказывают крупные производители
                    различных продуктов, малый и средний бизнес, покупают ПЭТ-бутылки и ПЭТ-банки в розницу. ПЭТ- продукция
                    компании обладает неоспоримыми преимуществами
                </p>
                <ul class="about-adv__list">
                    ...
                    <li class="about-adv__item">
                        <h3>Лёгкий вес</h3>
                        <p>В больших оптовых заказах вес имеет значение. Небольшой вес наших изделий сокращает компаниям
                            расходы на транспортную логистику.</p>
                    </li>
                    <li class="about-adv__item">
                        <h3>Лёгкая транспортировка</h3>
                        <p>За счёт прочности и легкого веса изделий транспортировка не занимает много времени и физических
                            сил.</p>
                    </li>
                    <li class="about-adv__item">
                        <h3>Низкая цена</h3>
                    ...
                    <li class="about-adv__item">
                        ...
                        <p>Для производителя важно, чтобы упаковка их продукции имела презентабельный внешний вид – мы
                            уделяем этому особое внимание.</p>
                    </li>
                </ul>
                <div class="about-adv__block">
                    Пластиковые изделия компании можно заказать большими партиями и без задержек производства – за это
                    клиенты нас ценят
                </div>
            </div>
        </section>
        ...
        <section class="about-number">
            <div class="container">
                ...
                <p class="about-number__text">
                    Производство Альфапласт заботится о благополучии клиентов и не меньше заботится об экологии. Материал
                    ПЭТ (полиэтилентерефталат) мы выбрали за его свойства
                </p>
                <ul class="about-number__list">
                    <li>
                        <h3>Экологичный</h3>
                        <p>ПЭТ легко перерабатывается, поэтому его предпочитают среди других сложноперерабатываемых
                            материалов.</p>
                    </li>
                    <li>
                        <h3>Внешние характеристики</h3>
                        <p>Прозрачность и чистота ПЭТ напоминает хрустальное стекло, при этом материал лёгкий, прочный и
                            обладает повышенной устойчивостью к высокому давлению.</p>
                    </li>
                    <li>
                        <h3>Безопасен для хранения</h3>
                        <p>Особенно важно это для пищевых продуктов. ПЭТ помогает сохранить пищу в безопасности и не
                            повредить при транспортировке</p>
                    </li>
                    <li>
                        <h3>Лёгкое термоформирование</h3>
                        <p>ПЭТ обладает боее высокой теплопроводностью по сравнению с другими материалами, поэтому ему
                            требуется меньше энергии для формовки и временной цикл производства короче.</p>
                    </li>
                </ul>
                <div class="about-number__block">
                    На сайте Альфапласт представлены все популярные модели бутылок, банок, флаконов, преформ и крышек из
                    ПЭТ. У нас можно купить ПЭТ-тару оптом, заказать выдув ПЭТ или создать прессформу по индивидуальному
                    заказу – мы будем рады сотрудничеству с вами!
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row about-catalog__list">
                    ...
                    <div class="col-md-6 col-lg-4 about-catalog__item">
                        ...
                        <a class="btn-hover" data-bs-toggle="modal" data-bs-target="#myModal">Смотреть</a>
                    </div>
                </div>
